...
Debido a un problema con los servidores de IS, la información solo puede almacenarse en esta aplicación, por lo que para poder aumentar
...
int main() {
    ...
    l->rellenarLista(*c1, *l);    l->rellenarLista(*c2, *l);  l->rellenarLista(*c3, *l);
